    ...
    echo '<div class="footer-b">';
        echo '<div class="container">'; 
            echo '<div class="site-info">';
                ...
                printf( '&nbsp;%s', '<a href="'. esc_url( __( 'http://prosystheme.com/wordpress-themes/business-times/', 'business-times' ) ) .'" target="_blank">'. esc_html__( 'Business Times By Prosys Theme. ', 'business-times' ) .'</a>' );
