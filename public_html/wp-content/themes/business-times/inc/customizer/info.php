...
function business_times_customizer_theme_info( $wp_customize ) {
	...
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Documentation', 'business-times' ) . ': </label><a href="' . esc_url( 'http://prosystheme.com/documentation/business-times/' ) . '" target="_blank">' . __( 'here', 'business-times' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Demo', 'business-times' ) . ': </label><a href="' . esc_url( 'http://prosystheme.com/preview/business-times/' ) . '" target="_blank">' . __( 'here', 'business-times' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Support Forum', 'business-times' ) . ': </label><a href="' . esc_url( 'http://prosystheme.com/support-forum/' ) . '" target="_blank">' . __( 'here', 'business-times' ) . '</a></span><br />';
	...
	$manager->add_section(
		new Business_Times_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => 'http://prosystheme.com/wordpress-themes/business-times-pro/'
			)
		)
	);
}