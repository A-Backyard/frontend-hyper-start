 ...
 * Description: Effortlessly include any CSS or JavaScript Library hosted at cdnjs.com on your WordPress site. Browse, select version and sub-assets to fit your needs.
 * Version: 0.3.3
...
/**
 *
 * Copyright 2018  Mindshare Studios, Inc. (http://mind.sh/are/)
 *
 ...
 * Updated configuration and CDNjs parsing + assets management by Eric Derewonko https://www.derewonko.com
 *
...
if(!defined('WP_CDNJS_VERSION')) {
	define('WP_CDNJS_VERSION', '0.3.3');
}

if(!defined('WP_CDNJS_MIN_WP_VERSION')) {
	define('WP_CDNJS_MIN_WP_VERSION', '5.1');
}
	...
	class wp_cdnjs {
      ...
      add_action('admin_menu', array($this, 'admin_menu'), 99);
		...
		public function load_textdomain() {
			load_plugin_textdomain('wp-cdnjs', false, basename( dirname( __FILE__ ) ) . '/languages');
		}
     ...
     /**
      ...
      add_options_page(
        ...
        '<img class="menu_cdnjs" src="'. WP_CDNJS_DIR_URL .'/assets/images/menu-icon.png" alt="" />' . __(WP_CDNJS_PLUGIN_NAME, 'wp-cdnjs'), 
        'manage_options', 
      ...
      // add_submenu_page( $parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function = '' );
			add_submenu_page(
        'options-general.php', 
        __(WP_CDNJS_PLUGIN_NAME, 'wp-cdnjs'), 
        '<img class="menu_cdnjs" src="'. WP_CDNJS_DIR_URL .'/images/menu-icon.png" alt="" />' . __(WP_CDNJS_PLUGIN_NAME, 'wp-cdnjs'), 
        'manage_options', 
        WP_CDNJS_PLUGIN_SLUG, 
        array( $this, 'settings_page' )
      );
      */
      ...
      //echo '<pre>'.print_r($settings, TRUE).'</pre>';
		...
		public function register_admin_scripts() {
			...
			wp_register_script('wp-cdnjs', WP_CDNJS_DIR_URL.'/assets/js/wp-cdnjs.js', array('jquery'), filemtime(WP_CDNJS_DIR_PATH.'/assets/js/wp-cdnjs.js'));
