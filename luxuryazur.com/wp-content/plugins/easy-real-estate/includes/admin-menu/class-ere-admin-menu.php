...
class ERE_Admin_Menu {
	...
	public function expand_menu() {
		...
		$menu_arr        = apply_filters( 'ere_expan_menus_slugs', $final_menu_list );
		...
		if ( in_array( $screen->id, $menu_arr ) ) {
			...
			<script type="text/javascript">
				...
				jQuery("#toplevel_page_easy-real-estate").addClass('wp-has-current-submenu wp-menu-open').removeClass('wp-not-current-submenu');
				jQuery("#toplevel_page_easy-real-estate > a").addClass('wp-has-current-submenu wp-menu-open').removeClass('wp-not-current-submenu');
