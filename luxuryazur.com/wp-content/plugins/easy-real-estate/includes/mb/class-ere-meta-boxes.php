...
class ERE_Meta_Boxes {
	...
	public static function init() {
		...
		// Additional details meta boxes for property
		include_once( ERE_PLUGIN_DIR . '/includes/mb/custom/class-ere-additional-details-meta-boxes.php' );
		...
		if ( is_plugin_active( 'meta-box/meta-box.php' ) ) {
			...
			add_action( 'admin_notices', function () {
				...
				<div class="update-nag notice is-dismissible">
					...
					<p><em><?php _e( 'So, You should completely remove it from your plugins.', 'easy-real-estate' ); ?></em></p>
				</div>
				<?php
			} );
		}
