...
//		$this->add_responsive_control(
//			'ere_property_featured_tag_padding',
//			[
//				'label'      => esc_html__( 'Featured Tag Padding', 'realhomes-elementor-addon' ),
//				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
//				'size_units' => [ 'px', '%', 'em' ],
//				'selectors'  => [
//					'{{WRAPPER}} .classic_properties_elementor_wrapper .rhea_is_featured' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
//				],
//			]
//		);
...
//		$property_featured_label       = $settings['ere_property_featured_label'];
        ...
        <div id="rh-<?php echo $this->get_id(); ?>" class="rhea_properties_default_classic rhea_ele_property_ajax_target rhea_latest_properties_ajax_classic">
                                        ...
                                        <div class="rhea_property_detail">
                                            <div class="rhea_property_price_bar">
                                                <h5 class="rhea_prop_card__price">
                                                    <span class="rhea_price"><?php ere_property_price(); ?></span>
													<?php echo ere_get_property_types( get_the_ID() ); ?>
                                                </h5>
                                            </div>
