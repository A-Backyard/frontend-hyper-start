...
class RHEA_Properties_Widget_three extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'ere_show_agents',
			[
				'label'        => esc_html__( 'Show Property Agents', 'realhomes-elementor-addon' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'realhomes-elementor-addon' ),
				'label_off'    => esc_html__( 'No', 'realhomes-elementor-addon' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'F j, Y',
				'condition' => [
					'ere_choose_post_time_formats' => 'default',
				],
			]
		);
...
// Filter based on custom taxonomies
        ...
        <section id="rh-<?php echo $this->get_id(); ?>"
                 class="rhea_ele_property_ajax_target rhea_latest_properties_ajax rhea_has_tooltip">
                            ...
                            <div class="rhea_property_card_ele_stylish">
                                <div class="rhea_property_card_ele_stylish_inner">
                                    <div class="rhea_thumbnail_wrapper">
                                        ...
                                        <div class="rhea_bottom_tags_box">
											...
											if ( 'yes' == $settings['ere_show_property_type'] ) {
												...
												if ( ! empty( $type_terms ) ) {
													if ( ! empty( ere_get_property_types( get_the_ID() ) ) ) {
														?>
                                    ...
                                    <div class="rhea_wrapper_bottom_agent">
										<?php
										if ( $settings['ere_show_agents'] == 'yes' ) {
        ...
        <script type="application/javascript">
            ...
            jQuery('body').on('click', '.rhea_agents_expand_button.rhea_open', function (e) {
            ...
            jQuery('body').on('click', '.rhea_agents_expand_button.rhea_close', function (e) {
