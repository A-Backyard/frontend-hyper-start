        ...
        <div class="left-box">
            ...
            <p><?php
				...
				if ( isset( $args['display_author'] ) && ( $args['display_author'] ) ) {
					?>
                    <a class="real-btn"
                       href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php echo esc_html( $button_label ); ?></a><?php
				} else {
					?>
                    <a class="real-btn"
                       href="<?php echo get_permalink( $args['agent_id'] ); ?>"><?php echo esc_html( $button_label ); ?></a><?php
				}
				?></p>
        </div>
		...
		if ( isset( $args['agent_email'] ) && ! empty( $args['agent_email'] ) ) {
            ...
            <div class="contact-form">
                ...
                <form id="<?php echo esc_attr( $agent_form_id ); ?>" class="agent-form contact-form-small"
                    ...
                    <input type="text" name="name" placeholder="<?php _e( 'Name', 'framework' ); ?>" class="required"
                           title="<?php _e( '* Please provide your name', 'framework' ); ?>">
                    <input type="text" name="email" placeholder="<?php _e( 'Email', 'framework' ); ?>"
                           class="email required"
                           title="<?php _e( '* Please provide valid email address', 'framework' ); ?>">
                    <input type="text" name="phone" placeholder="<?php _e( 'Phone', 'framework' ); ?>"
                           class="digits required"
                           title="<?php _e( '* Please provide valid phone number', 'framework' ); ?>">
                    <textarea name="message" class="required" placeholder="<?php _e( 'Message', 'framework' ); ?>"
                              title="<?php _e( '* Please provide your message', 'framework' ); ?>"></textarea>
					<?php
	                ...
	                ?>
                    <input type="hidden" name="author_name" value="<?php echo esc_attr( $args['author_display_name'] ) ?>">
                    <?php
	                }
	                ?>
                    ...
                    <input type="submit" value="<?php _e( 'Send Message', 'framework' ); ?>" name="submit"
