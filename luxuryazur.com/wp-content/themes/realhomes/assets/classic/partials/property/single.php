					...
					if ( have_posts() ) :
						while ( have_posts() ) :
							...
							if ( ! post_password_required() ) {
								...
								if ( has_post_thumbnail() || ( ! empty( $properties_images ) && count( $properties_images ) ) ) {
									...
									<div class="slider-main-wrapper">
										...
										if ( 'thumb-on-bottom' == $gallery_slider_type ) {
											...
											get_template_part( 'assets/classic/partials/property/single/slider' );	// slider with thumbs on right.
										}
										?>
										<div class="slider-socket <?php echo esc_attr( $gallery_slider_type ); ?>">
											<?php get_template_part( 'assets/classic/partials/property/single/add-to-favorites' );	// add to favorites. ?>
								 ...
								 * Google Map
								 */
								get_template_part( 'assets/classic/partials/property/single/map' );
