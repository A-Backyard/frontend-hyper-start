<div class="form-option checkbox-option clearfix terms-field-wrapper">
	<?php
		...
		$terms_note     = get_option( 'inspiry_submit_property_terms_text', __( 'Accept Terms & Conditions before property submission.', 'framework' ) );
	...
	?><label for="terms"><?php echo $terms_note; // no need to escape ?></label>
