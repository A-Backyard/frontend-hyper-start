...
<div class="option-bar rh-search-field small">
	...
	<input type="text" name="min-area" id="min-area" pattern="[0-9]+"
	       ...
	       placeholder="<?php echo empty($min_area_placeholder) ? ere_any_text() : esc_attr($min_area_placeholder); ?>"
...
<div class="option-bar rh-search-field small">
	...
	<input type="text" name="max-area" id="max-area" pattern="[0-9]+"
	       ...
	       placeholder="<?php echo empty($max_area_placeholder) ? ere_any_text() : esc_attr($max_area_placeholder); ?>"
	       title="<?php _e('Only provide digits!', 'framework'); ?>" />
</div>