...
for ( $i = 0; $i < $location_select_count; $i++ ) {
	?>
	<div class="rh_prop_search__option rh_location_prop_search_<?php echo $i ?> rh_prop_search__select" data-get-location-placeholder="<?php echo $location_placeholder[$i] ?>">
