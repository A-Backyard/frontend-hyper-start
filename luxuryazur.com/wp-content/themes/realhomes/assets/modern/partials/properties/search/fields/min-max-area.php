...
<div class="rh_prop_search__option">
	...
	<input type="text" name="min-area" id="min-area" pattern="[0-9]+"
	       ...
	       placeholder="<?php echo empty( $min_area_placeholder ) ? esc_attr( ere_any_text() ) : esc_attr( $min_area_placeholder ); ?>"
...
<div class="rh_prop_search__option">
	...
	<input type="text" name="max-area" id="max-area" pattern="[0-9]+"
	       ...
	       placeholder="<?php echo empty( $max_area_placeholder ) ? esc_attr( ere_any_text() ) : esc_attr( $max_area_placeholder ); ?>"
	       title="<?php esc_attr_e( 'Only provide digits!', 'framework' ); ?>" />
</div>
