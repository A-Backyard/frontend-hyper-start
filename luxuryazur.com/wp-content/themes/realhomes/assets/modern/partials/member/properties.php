...
if ( $my_post_count < $my_post_found ) {
	$show_information = '<h2 class="rh_page__title"><span class="sub">' . $my_post_count . esc_html__(' of ' ,'framework') . $my_post_found . '</span><span class="title">' . esc_html__( ' Properties', 'framework' ) . '</span></h2>';
} elseif ( $my_post_count == 1 ) {
	$show_information = '<h2 class="rh_page__title"><span class="sub">' . $my_post_count . '</span><span class="title">' . esc_html__( ' Property', 'framework' ) . '</span></h2>';
} else {
	$show_information = '<h2 class="rh_page__title"><span class="sub">' . $my_post_count . '</span><span class="title">' . esc_html__( ' Properties', 'framework' ) . '</span></h2>';
}
?>
            ...
            <div class="rh_page__nav rh_page__nav_properties">
                <div class="property-count-box">
		            ...
		            if ( is_user_logged_in() ) {
			            echo $show_information; // should not be escaped
		            }
		            ?>
                </div>
