...
if ( ! function_exists( 'inspiry_generate_dynamic_css' ) ) {
	...
	function inspiry_generate_dynamic_css() {
		...
		$dynamic_css = array(
			...
			array(
				'elements' => '.inspiry-language-switcher .inspiry-language.current:hover, 
							   .rh_header_var_1 ul.rh_menu__main > .current-menu-item > a,
							   .rh_header_var_1 ul.rh_menu__main li:hover,
							   .rh_header_var_1 ul.rh_menu__main li a:hover,
			...
			array(
				'elements' => '.rh_header_var_1 ul.rh_menu__main ul.sub-menu li:hover > a,
			...
			array(
				'elements' => '.rh_section__testimonial .diagonal-mod-background,
								.rh_section__testimonial.flat-border',
				'property' => 'background-color',
