...
if ( ! function_exists( 'inspiry_features_section_customizer' ) ) :
	...
	function inspiry_features_section_customizer( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_setting( 'inspiry_features_section_home_first_feature', array() );
		$wp_customize->add_control(
		...
		$wp_customize->add_setting( 'inspiry_features_section_home_second_feature', array() );
		$wp_customize->add_control(
			new Inspiry_Heading_Customize_Control(
				$wp_customize,
		...
		$wp_customize->add_setting( 'inspiry_features_section_home_third_feature', array() );
		$wp_customize->add_control(
			new Inspiry_Heading_Customize_Control(
				$wp_customize,
