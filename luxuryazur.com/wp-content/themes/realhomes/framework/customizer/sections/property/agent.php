	...
	function inspiry_property_agent_customizer( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_setting( 'inspiry_property_agent_label', array(
			...
			$wp_customize->add_control( 'inspiry_property_agent_label', array(
				'label' => esc_html__( 'Agent Prefix', 'framework' ),
				'type' => 'text',
				'section' => 'inspiry_property_agent',
			) );
		...
		$wp_customize->add_setting( 'inspiry_basic_settings_note_agent', array() );
		$wp_customize->add_control(
			new Inspiry_Intro_Customize_Control(
				$wp_customize,
				'inspiry_basic_settings_note_agent',
				array(
					'section'     => 'inspiry_property_agent',
					'label'       => esc_html__( 'Important Note:', 'framework' ),
					'description' => esc_html__( "For agent form layout on property detail page, please go to Customizer > Property Detail Page > Basics .", 'framework' ),
				)
			)
		);
