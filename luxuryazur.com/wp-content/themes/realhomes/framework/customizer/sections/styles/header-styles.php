		...
		if ( 'modern' === INSPIRY_DESIGN_VARIATION ) {
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Menu wrapper Background Color', 'framework' ),
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Header Meta wrapper Background Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
...
//			'default' => $default_header_bg,
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label' => __( 'Header/Banner Background Color', 'framework' ),
					'section' => 'inspiry_header_styles',
...
//			'default' => $default_logo_hover,
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label' => __( 'Main Menu Text Hover Color', 'framework' ),
					'section' => 'inspiry_header_styles',
				)
			)
		);
...
//				'default' => '#ea723d',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label' => __( 'Main Menu Hover Background/border', 'framework' ),
						'section' => 'inspiry_header_styles',
...
//			'default' => $default_dd_menu_text_color,
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label' => __( 'Drop Down Menu Text Color on Mouse Over', 'framework' ),
					'section' => 'inspiry_header_styles',
...
//			'default' => $default_phone_text_color,
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label' => __( 'Phone Number Text Color', 'framework' ),
						'section' => 'inspiry_header_styles',
		...
		if( 'modern' === INSPIRY_DESIGN_VARIATION ) {
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'theme_phone_text_color',
					array(
						'label' => __( 'Phone/Email Number Text Color', 'framework' ),
						'section' => 'inspiry_header_styles',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label' => __( 'Phone/Email Number Text Hover Color', 'framework' ),
						'section' => 'inspiry_header_styles',
						'description' => esc_html__('Default color is #ffffff','framework'),
					)
				)
		...
		if ( 'modern' === INSPIRY_DESIGN_VARIATION ) {
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Social Icon Hover Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
						'active_callback' => 'inspiry_header_variation_option_two'
					)
				)
...
//				'default' => '#37b3d9',
		...
		$wp_customize->add_setting( 'theme_language_switcher_bg_color', array(
			'type' => 'option',
			'sanitize_callback' => 'sanitize_hex_color',
		) );
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label' => __( 'Language Switch Background Color', 'framework' ),
					'section' => 'inspiry_header_styles',
		...
		$wp_customize->add_setting( 'theme_language_switcher_link_color', array(
			'type' => 'option',
			'sanitize_callback' => 'sanitize_hex_color',
		) );
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label' => __( 'Language Switch Link Color', 'framework' ),
					'section' => 'inspiry_header_styles',
					'description' => sprintf(esc_html__('Default Color is %s','framework') , '#808080'),
				)
			)
		);

		$wp_customize->add_setting( 'theme_language_switcher_link_hover_color', array(
			'type' => 'option',
			'sanitize_callback' => 'sanitize_hex_color',
		) );
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label' => __( 'Language Switch Link Hover Color', 'framework' ),
					'section' => 'inspiry_header_styles',
					'description' => sprintf(esc_html__('Default Color is %s','framework') , '#000000'),
				)
			)
		);
		...
		if ( 'modern' == INSPIRY_DESIGN_VARIATION ) {
			...
			$wp_customize->add_setting( 'inspiry_home_sticky_header_labels', array() );
			$wp_customize->add_control(
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Site Title Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Site Title Hover Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
						'description' => sprintf( esc_html__( 'Default Color is %s', 'framework' ), '#444444' ),
					)
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Sticky Header Background', 'framework' ),
						'section'     => 'inspiry_header_styles',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Sticky Header Menu Text Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
						'description' => sprintf( esc_html__( 'Default Color is %s', 'framework' ), '#ffffff' ),
					)
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Sticky Header Menu Background Hover Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
						'description' => sprintf( esc_html__( 'Default Color is %s', 'framework' ), '#ffffff' ),
					)
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Sticky Header Menu Hover Text Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
						'description' => sprintf( esc_html__( 'Default Color is %s', 'framework' ), '#444444' ),
					)
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Sticky Header Contacts Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
						'description' => sprintf( esc_html__( 'Default Color is %s', 'framework' ), '#ffffff' ),
					)
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Sticky Header Submit Button Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
						'description' => sprintf( esc_html__( 'Default Color is %s', 'framework' ), '#ffffff' ),
					)
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Sticky Header Submit Button Hover Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
						'description' => sprintf( esc_html__( 'Default Color is %s', 'framework' ), '#ffffff' ),
					)
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'label'       => __( 'Sticky Header Submit Button Hover Text Color', 'framework' ),
						'section'     => 'inspiry_header_styles',
						'description' => sprintf( esc_html__( 'Default Color is %s', 'framework' ), '#444444' ),
					)
				)
