...
if ( ! function_exists( 'inspiry_home_page_styles_customizer' ) ) {
	...
	function inspiry_home_page_styles_customizer( WP_Customize_Manager $wp_customize ){
		...
		if ( 'modern' === INSPIRY_DESIGN_VARIATION ) {
			...
			$wp_customize->add_setting( 'inspiry_home_properties_sep_labels', array() );
...
//			);
			...
			$wp_customize->add_setting( 'inspiry_featured_properties_sep_labels', array() );
			$wp_customize->add_control(
				new Inspiry_Heading_Customize_Control(
					$wp_customize,
...
//				'default'	=> '#1ea69a',
			...
			$wp_customize->add_setting( 'inspiry_featured_testimonials_sep_labels', array() );
			$wp_customize->add_control(
				new Inspiry_Heading_Customize_Control(
					$wp_customize,
...
//			'default'	=> '#1ea69a',
			...
			$wp_customize->add_setting( 'inspiry_home_cta_sep_labels', array() );
			$wp_customize->add_control(
				new Inspiry_Heading_Customize_Control(
					$wp_customize,
...
//			'default' => '#ea723d',
			...
			$wp_customize->add_setting( 'inspiry_agents_home_sep_labels', array() );
			$wp_customize->add_control(
				new Inspiry_Heading_Customize_Control(
					$wp_customize,
...
//			'default'	=> '#1ea69a',
			...
			$wp_customize->add_setting( 'inspiry_features_home_sep_labels', array() );
			$wp_customize->add_control(
				new Inspiry_Heading_Customize_Control(
					$wp_customize,
...
//			'default'	=> '#1ea69a',
			...
			$wp_customize->add_setting( 'inspiry_partners_home_sep_labels', array() );
			$wp_customize->add_control(
				new Inspiry_Heading_Customize_Control(
					$wp_customize,
...
//			'default'	=> '#1ea69a',
			...
			$wp_customize->add_setting( 'inspiry_news_home_sep_labels', array() );
			$wp_customize->add_control(
				new Inspiry_Heading_Customize_Control(
					$wp_customize,
...
//			'default'	=> '#1ea69a',
			...
			$wp_customize->add_setting( 'inspiry_cta_contact_home_sep_labels', array() );
			$wp_customize->add_control(
				new Inspiry_Heading_Customize_Control(
					$wp_customize,
...
//			'default'	=> '#1EA69A',
		...
		if ( 'classic' === INSPIRY_DESIGN_VARIATION ) {
			$wp_customize->add_setting( 'inspiry_features_section_home_sep_labels', array() );
			$wp_customize->add_control(
				new Inspiry_Heading_Customize_Control(
					$wp_customize,
