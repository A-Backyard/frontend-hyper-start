...
if ( ! function_exists( 'inspiry_contact_customizer' ) ) :
	function inspiry_contact_customizer( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_setting( 'inspiry_contact_note', array() );
		...
		// separator
		$wp_customize->add_setting( 'inspiry_contact_map_separator', array() );
		$wp_customize->add_control(
		...
		$wp_customize->add_control( 'theme_map_lati', array(
			'label'       => __( 'Map Latitude', 'framework' ),
		...
		$wp_customize->add_control( 'theme_map_longi', array(
			'label'   => __( 'Map Longitude', 'framework' ),
			'type'    => 'text',
			'section' => 'inspiry_contact_section',
		) );
		...
		$wp_customize->add_control( 'theme_map_zoom', array(
			'label'       => __( 'Map Zoom Level', 'framework' ),
			'description' => __( 'Provide Map Zoom Level.', 'framework' ),
			'type'        => 'number',
			'section'     => 'inspiry_contact_section',
		) );
