...
<div class="wrap about-wrap">
	...
	<div class="rh_design__wrap">
		...
		<form action="<?php menu_page_url( 'inspiry-real-homes-design' ); ?>" method="POST" id="rh_design__form">
			...
			<div class="feature-section rh_design__two-cols">

				<?php $rh_design_variation = get_option( 'inspiry_design_variation', 'classic' ); ?>

				<div class="rh_design__column">
			...
			<!-- /.feature-section rh_design__two-col -->

			<div class="feature-section rh_design__one-col rh_design__note">
				<p>
			...
			<!-- /.feature-section rh_design__one-col -->

			<div class="feature-section rh_design__one-col">
